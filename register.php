<!--CREATE TABLE `funky_fest`.`members` (`M_ID` INT(1000) NULL DEFAULT NULL AUTO_INCREMENT , `Username` TEXT NULL DEFAULT NULL , `Email` TEXT NOT NULL , `Password` TEXT NULL DEFAULT NULL , PRIMARY KEY (`M_ID`)) ENGINE = InnoDB;-->
<?php
session_start();
include "config.php";
if(isset($_POST["sub"]))
	  {
		  ...
		  if($member_check ==0)
		  {
			  ...
			  $query = mysqli_query($conn,"INSERT INTO Members VALUES(0,'$username','$email','$pass')") 
...
<div class="container">
    ...
    <form action="register.php"method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <div id="username" class="form-text">Fill a desired username.</div>
          </div>
        ...
        <div class="mb-3 form-check">
          ...
          <label class="form-check-label" for="exampleCheck1">Agree with the T&C</label></br>
        <a href="login.html">Already have an account?</a>
          
        </div>
        <button name="sub" type="submit" class="btn btn-primary">Register</button>
      </form>
